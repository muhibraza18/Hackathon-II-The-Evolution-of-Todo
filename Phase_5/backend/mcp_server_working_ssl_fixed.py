"""
Fixed MCP Server with Database Integration
This version removes forced SSL parameters to work with local PostgreSQL
"""
import asyncio
import logging
import os
...
if __name__ == '__main__':
    ...
    logger.info(f"📊 Database: Local PostgreSQL (development mode)")
    logger.info(f"🔗 Health check: http://0.0.0.0:{port}/health")
    logger.info("=" * 60)

    # FIXED: Bind to 0.0.0.0 to make it accessible from outside the container
