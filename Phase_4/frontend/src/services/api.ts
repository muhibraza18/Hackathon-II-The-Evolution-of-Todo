...
class ApiService {
  ...
  constructor() {
    // Use environment variable for API base URL to work in Kubernetes environment
  ...
  async login(credentials: any) {
    ...
    console.log("DEBUG: Full request URL:", `${this.baseUrl}${API_ENDPOINTS.LOGIN}`);

    try {
      const result = await this.request(API_ENDPOINTS.LOGIN, options);
