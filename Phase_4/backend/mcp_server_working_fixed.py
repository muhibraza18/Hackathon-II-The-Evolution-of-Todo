...
if __name__ == '__main__':
    ...
    logger.info(f"🔗 Health check: http://0.0.0.0:{port}/health")  # Changed from localhost to 0.0.0.0
    logger.info("=" * 60)

    # FIXED: Bind to 0.0.0.0 instead of localhost to make it accessible from outside the container
    web.run_app(app, host='0.0.0.0', port=port)  # Changed from 'localhost' to '0.0.0.0'